                    ...
                    <li>
                        <select name="blockbee_coin" id="payment_blockbee_coin" class="input-control" style="display:block; margin-top: 10px">
							...
							foreach ( $this->coins as $val ) {
								$apikey = $this->api_key;
								if ( ! empty( $apikey ) ) { ?>
                                    <option data-image="<?php echo esc_url( WC_BlockBee_Gateway::$COIN_OPTIONS[ $val ]['logo'] ); ?>" value="<?php echo esc_attr( $val ); ?>" <?php
                    ...
                    <div class="blockbee_payments_wrapper">
						...
						?>; width: <?php echo intval( $this->qrcode_size ) + 20; ?>px;">
							...
							if ( $crypto_allowed_value == true ) {
                                ...
                                <div class="inner-wrapper">
                                    <figure>
										...
										if ( $qr_code_setting != 'hide_amount' ) {
											...
											?> src="data:image/png;base64,<?php echo $qr_code_img; ?>" alt="<?php echo esc_attr(__( 'QR Code without value', 'blockbee-cryptocurrency-payment-gateway' )); ?>"/>
											<?php
										}
                                ...
                                <div class="inner-wrapper">
                                    ...
                                    <div class="blockbee_qrcode_buttons">
                                        <button class="blockbee_qrcode_btn no_value active" aria-label="<?php echo esc_attr(__( 'Show QR Code without value', 'blockbee-cryptocurrency-payment-gateway' )); ?>">
											<?php echo esc_attr( __( 'ADDRESS', 'blockbee-cryptocurrency-payment-gateway' )); ?>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="blockbee_details_box">
                            <div class="blockbee_details_text">
                                ...
                                <button class="blockbee_copy blockbee_details_copy" data-tocopy="<?php echo esc_attr($crypto_value); ?>">
                            ...
                            <div class="blockbee_details_input">
                                ...
                                <button class="blockbee_copy blockbee_copy_icon" data-tocopy="<?php echo esc_attr($address_in); ?>">
                                    <span class="blockbee_tooltip blockbee_copy_icon_tooltip tip"><?php echo esc_attr(__( 'COPY', 'blockbee-cryptocurrency-payment-gateway' )); ?></span>
                                    <span class="blockbee_tooltip blockbee_copy_icon_tooltip success" style="display: none"><?php echo esc_attr( __( 'COPIED!', 'blockbee-cryptocurrency-payment-gateway' )); ?></span>
                                </button>
						...
						if ( $this->show_branding ) {
                            ...
                            <div class="blockbee_branding">
                                <a href="https://blockbee.io/" target="_blank">
                                    ...
                                    <img width="94" class="img-fluid" src="<?php echo esc_url(BLOCKBEE_PLUGIN_URL . 'static/files/blockbee_logo.png') ?>" alt="BlockBee Logo"/>
                                </a>
                            </div>
							<?php
						}
                ...
                <div class="blockbee_history" style="display: none;">
                    <table class="blockbee_history_fill">
                        <tr class="blockbee_history_header">
                            <th><strong><?php echo esc_attr( __( 'Time', 'blockbee-cryptocurrency-payment-gateway' )); ?></strong></th>
                            <th><strong><?php echo esc_attr(__( 'Value Paid', 'blockbee-cryptocurrency-payment-gateway' )); ?></strong></th>
                            <th><strong><?php echo esc_attr(__( 'FIAT Value', 'blockbee-cryptocurrency-payment-gateway' )); ?></strong></th>
                        </tr>
                    </table>
                </div>
				<?php
